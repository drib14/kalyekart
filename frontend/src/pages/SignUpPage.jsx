						...
						<div>
							...
							<div className='mt-1 relative rounded-lg shadow-sm'>
								...
								<input
									...
									className='block w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-lg shadow-sm
							...
							<div className='mt-1 relative rounded-lg shadow-sm'>
								...
								<input
									...
									className=' block w-full px-3 py-2 pl-10 bg-gray-700 border
									 border-gray-600 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm'
									placeholder='••••••••'
								/>
							</div>
						</div>
